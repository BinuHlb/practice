...
<body>
    ...
    <?= $this->element("nav-light") ?>

    <!-- =========== Hero Section Start =========== -->
    <section class="relative pt-32 pb-20 bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black" id="home">
        <div class="container">

            <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-6 gap-y-10 items-center">
                <div class="relative">
                    <h1 class="text-3xl md:text-5xl/tight lg:text-6xl/tight text-white tracking-normal capitalize leading-normal font-bold max-w-2xl mt-4">Make Your Life Even Easier with Statistical <span class="text-primary">Progress</span></h1>
                    <p class="text-base text-white font-medium max-w-lg mt-6 capitalize">Our app provides a multitude of features tailored to your needs. From personalized recommendations to exclusive offers.</p>
                    ...
                    <div class="flex flex-wrap mt-9 text-center gap-3">
                        ...
                        <button  class="py-2 px-6 text-white rounded-md border border-white text-base hover:border-white hover:bg-white hover:text-primary transition-all duration-500 font-medium">See Pricing</button>
                    </div>

                </div>

                <div class="relative">
                    <img src="/images/statistical.png" class="md:h-[600px] lg:ms-auto mx-auto" alt="">
                </div>
            </div>
        </div>
    </section>
