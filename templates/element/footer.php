        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 pb-16 pt-16">
            <div class="col-span-full lg:col-span-2">
                <div class="max-w-2xl mx-auto">
                    <div class="flex items-center">
                        <img src="/images/w-practice.svg" alt="" class="h-10 me-5">
                    </div>
                    <p class="text-gray-300 max-w-xs mt-6">One Platform, Endless Possibilities for Smarter Work Management.</p>
                </div>
            ...
            <div class="col-span-1">
                ...
                <div class="mt-6 grid space-y-3">
                    ...
                    <p><a class="inline-flex gap-x-2 text-base text-gray-300 hover:text-gray-400 transition-all duration-300" href="privacy">Privacy Policy </a></p>
    ...
    <div class="py-4 bg-[#1C2940]">
        ...
        <div class="container">
            <div class="flex justify-between items-center">
                <p class="text-base text-white"><script>document.write(new Date().getFullYear())</script>© Difinity </p>
